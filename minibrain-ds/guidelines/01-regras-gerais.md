# Regras Gerais Obrigatórias (MiniBrain — Vanilla TypeScript)
...
* **É OBRIGATÓRIO usar as classes `.mbds-*` definidas em `./styles/components/*.css` (CSS standalone, sem Tailwind)**
...
* **Use classes tipográficas `.mbds-text-*` / `.mbds-leading-*`** — nunca valores arbitrários nem classes utilitárias de outro framework; a tipografia está definida no CSS base
