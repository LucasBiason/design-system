# Display Components (MiniBrain — Vanilla TypeScript)
...
- Estilos em `src/styles/components/data-table.css` registrado em `globals.css` — classes `.mbds-data-table-*`
