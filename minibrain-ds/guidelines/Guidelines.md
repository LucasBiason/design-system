# Documentação do Design System — Guidelines (MiniBrain)
...
> **Stack**: Vanilla TypeScript + CSS standalone (`.mbds-*`) + lucide (vanilla) + Zod + axe-playwright + Chromatic + Storybook 10 (`@storybook/html-vite`)
...
### 1. Fundamentos (MiniBrain — Vanilla TS)

- **[01-regras-gerais.md](./01-regras-gerais.md)** — Regras gerais obrigatórias do projeto MiniBrain (funções TypeScript, DOM, lucide vanilla)
...
### 2. Componentes por Categoria (MiniBrain / Vanilla TS)
...
### 3. Padrões e Práticas (MiniBrain)
...
### 4. Arquitetura e Design Sistema (MiniBrain)
...
2. Consulte as **guidelines MiniBrain** deste diretório para regras específicas de Vanilla TS e DOM
...
1. **Regras Gerais** (01) — Aplicam-se a todo o projeto MiniBrain
...
- Se a regra é específica do MiniBrain/Vanilla TS → adicionar neste diretório
