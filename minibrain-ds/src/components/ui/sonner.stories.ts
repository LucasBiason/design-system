...
function fireLocalToast(
  ...
  toastEl.className = 'mbds-cluster mbds-w-full mbds-rounded-lg mbds-p-4 mbds-shadow-lg';
  ...
  if (opts.description) {
    ...
    descEl.className = 'mbds-text-body mbds-text-muted-foreground mbds-mt-1';
  ...
  if (opts.action) {
    ...
    actionBtn.className = 'mbds-mt-2 mbds-text-body mbds-font-medium mbds-text-primary mbds-hover-underline';
