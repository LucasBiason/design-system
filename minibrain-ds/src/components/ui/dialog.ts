...
// Visual: classes .mbds-dialog-* (zero Tailwind/basecoat-css). Render via portal.
...
export function createDialog(options: DialogOptions): HTMLElement {
  ...
  function open(): void {
    ...
    overlayEl.className = 'mbds-dialog-overlay';
    ...
    panelEl.className = 'mbds-dialog-content';
    ...
    headerEl.className = 'mbds-dialog-header';
    headerEl.dataset.slot = 'dialog-header';

    const titleEl = document.createElement('h2');
    titleEl.id = titleId;
    titleEl.className = 'mbds-dialog-title';
    ...
    if (description) {
      ...
      descEl.id = descId;
      descEl.className = 'mbds-dialog-description';
    ...
    bodyEl.className = 'mbds-dialog-body';
    ...
    if (footer) {
      ...
      footerEl.className = 'mbds-dialog-footer';
    ...
    if (showCloseButton) {
      ...
      closeBtn.className = 'mbds-dialog-close';
      closeBtn.dataset.slot = 'dialog-close';
      closeBtn.setAttribute('aria-label', 'Close');
      closeBtn.appendChild(createCloseIcon());
      const srOnly = document.createElement('span');
      srOnly.className = 'mbds-sr-only';
