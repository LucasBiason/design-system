...
function buildDemoSidebar(args: SidebarArgs): HTMLElement {
  ...
  appLabel.className = 'mbds-cluster mbds-font-semibold mbds-text-body';
  ...
  userRow.className = 'mbds-cluster mbds-text-body';
  ...
  breadcrumb.className = 'mbds-text-body mbds-text-muted-foreground';
