...
// Visual: classes .mbds-form-* (zero Tailwind/basecoat-css).
...
export function createFormField(options: FormFieldOptions): HTMLElement {
  ...
  field.className = 'mbds-form-field';
  ...
  if (label) {
    ...
    labelEl.className = 'mbds-form-label';
  ...
  if (description) {
    ...
    descEl.className = 'mbds-form-description';
  ...
  if (error) {
    ...
    errorEl.className = 'mbds-form-error';
