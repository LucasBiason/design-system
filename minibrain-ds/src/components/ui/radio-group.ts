...
//
// Visual: classes .mbds-radio-* (zero Tailwind/basecoat-css).
// Estado controlado via aria-checked + display do .mbds-radio-indicator.
...
export function createRadioGroup(options: RadioGroupOptions): HTMLElement {
  ...
  fieldset.className = 'mbds-radio-group';
  ...
  items.forEach((item) => {
    ...
    rowEl.className = 'mbds-radio-row';
    ...
    itemBtn.className = 'mbds-radio-item';
    ...
    indicatorSpan.className = 'mbds-radio-indicator';
    ...
    labelEl.id = labelId;
    labelEl.className = 'mbds-radio-label';
