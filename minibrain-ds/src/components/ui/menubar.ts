...
// Visual: classes .mbds-menubar-* (zero Tailwind/basecoat-css).
...
export function createMenubar(menus: MenubarMenu[], options?: { class?: string }): HTMLElement {
  ...
  menus.forEach((menu, menuIdx) => {
    ...
    itemWrapper.className = 'mbds-menubar-menu';

    const trigger = document.createElement('button');
    trigger.type = 'button';
    trigger.className = 'mbds-menubar-trigger';
    ...
    panel.id = panelId;
    panel.className = 'mbds-menubar-panel';
    ...
    menu.items.forEach((item) => {
      if (item.type === 'separator') {
        ...
        sep.className = 'mbds-menubar-separator';
      ...
      if (item.type === 'label') {
        ...
        label.className = 'mbds-menubar-label';
      ...
      itemEl.className = 'mbds-menubar-item';
      ...
      if (item.shortcut) {
        ...
        shortcut.className = 'mbds-menubar-shortcut';
