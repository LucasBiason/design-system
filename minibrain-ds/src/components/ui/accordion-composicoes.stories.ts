  ...
  render: () => {
    ...
    if (layoutContent) {
      layoutContent.innerHTML = `
        <div class="mbds-stack mbds-text-body" data-spacing="sm">
          <div class="mbds-grid mbds-font-medium" data-cols="2" data-spacing="sm">
            <span class="mbds-text-muted-foreground">Propriedade</span>
            <span class="mbds-text-muted-foreground">Valor</span>
          </div>
          <div class="mbds-grid" data-cols="2" data-spacing="sm" style="border-top:1px solid var(--border);padding-top:0.5rem"><span>Gutter</span><code class="mbds-code-inline mbds-text-caption">24px</code></div>
          <div class="mbds-grid" data-cols="2" data-spacing="sm" style="border-top:1px solid var(--border);padding-top:0.5rem"><span>Margem mobile</span><code class="mbds-code-inline mbds-text-caption">16px</code></div>
          <div class="mbds-grid" data-cols="2" data-spacing="sm" style="border-top:1px solid var(--border);padding-top:0.5rem"><span>Colunas</span><code class="mbds-code-inline mbds-text-caption">12</code></div>
        </div>`;
    }
    ...
    if (tipoContent) {
      tipoContent.innerHTML = `
        <ul class="mbds-stack mbds-text-body mbds-list-none" data-spacing="xs" style="padding:0">
          <li class="mbds-cluster" data-spacing="sm"><code class="mbds-code-inline mbds-text-caption">text-xs</code><span>12px — legendas e labels</span></li>
          <li class="mbds-cluster" data-spacing="sm"><code class="mbds-code-inline mbds-text-caption">text-sm</code><span>14px — corpo principal</span></li>
          <li class="mbds-cluster" data-spacing="sm"><code class="mbds-code-inline mbds-text-caption">text-base</code><span>16px — títulos de seção</span></li>
        </ul>`;
    }
...
export const FAQ: Story = {
  render: () => {
    ...
    heading.className = 'mbds-text-h4 mbds-font-semibold';
