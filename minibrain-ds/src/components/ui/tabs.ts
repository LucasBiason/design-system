...
//
// Visual: classes .mbds-tabs-* (zero Tailwind/basecoat-css).
...
export function createTabs(options: TabsOptions): HTMLElement {
  ...
  items.forEach((item) => {
    ...
    panelEl.className = 'mbds-tabs-content';
  ...
  items.forEach((item) => {
    ...
    triggerEl.className = 'mbds-tabs-trigger';
