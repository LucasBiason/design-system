...
//
// Visual: classes .mbds-pagination-* (zero Tailwind/basecoat-css).
...
export function createPagination(options: PaginationOptions): HTMLElement {
  ...
  function makeLink(label: string | null, page: number, isCurrent = false): HTMLAnchorElement {
    ...
    a.href = '#';
    a.className = 'mbds-pagination-link';
  ...
  if (showPrevNext) {
    ...
    prevA.className = 'mbds-pagination-link mbds-pagination-icon';
  ...
  for (const page of pages) {
    if (page === 'ellipsis') {
      ...
      span.className = 'mbds-pagination-ellipsis';
  ...
  if (showPrevNext) {
    ...
    nextA.className = 'mbds-pagination-link mbds-pagination-icon';
