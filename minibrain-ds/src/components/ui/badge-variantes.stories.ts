...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const el = canvasElement.querySelector('.mbds-badge');
    await expect(el).not.toBeNull();
    // Default não aplica modificador — apenas .mbds-badge.
    await expect(el?.classList.contains('mbds-badge-secondary')).toBe(false);
    await expect(el?.classList.contains('mbds-badge-destructive')).toBe(false);
    await expect(el?.classList.contains('mbds-badge-outline')).toBe(false);
  },
};
...
export const Secondary: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const el = canvasElement.querySelector('.mbds-badge-secondary');
    await expect(el).not.toBeNull();
  },
};
...
export const Destructive: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const el = canvasElement.querySelector('.mbds-badge-destructive');
    await expect(el).not.toBeNull();
  },
};
...
export const Outline: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const el = canvasElement.querySelector('.mbds-badge-outline');
    await expect(el).not.toBeNull();
  },
};
