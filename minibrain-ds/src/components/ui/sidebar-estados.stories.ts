...
function buildBase(defaultOpen: boolean, collapsible?: 'offcanvas' | 'icon' | 'none'): HTMLElement {
  ...
  stateLabel.className = 'mbds-text-caption mbds-text-muted-foreground mbds-font-mono';
...
export const ModoIcon: Story = {
  ...
  render: () => {
    ...
    const header = createSidebarHeader();
    const logoRow = document.createElement('div');
    logoRow.className = 'mbds-cluster';
  ...
  topbar.style.paddingRight = '1rem';
    ...
    label.className = 'mbds-text-caption mbds-text-muted-foreground mbds-font-mono';
...
export const MobileOverlay: Story = {
  ...
  render: () => {
    ...
    infoEl.className = 'mbds-rounded mbds-bg-muted mbds-text-caption mbds-text-muted-foreground';
