...
function panelContent(label: string, extraClass = ''): HTMLElement {
  ...
  el.className = `mbds-cluster mbds-text-body mbds-font-medium ${extraClass}`.trim();
...
export const Playground: Story = {
  render: (args) => {
    const root = createResizablePanel({
      ...
      panels: [
        { defaultSize: args.defaultSizeA, minSize: args.minSizeA, content: panelContent('Painel A', 'mbds-bg-muted mbds-text-muted-foreground')},
