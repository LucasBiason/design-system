      ...
      case 'demonstracao':
        return createDocsDemonstration({
          ...
          demoFactory: () => {
            ...
            wrap.className = 'mbds-w-full mbds-stack';
            ...
            wrap.append(
              ...
              buildAlert('default', 'mbds-alert-success', 'success', 'demonstration.labels.successTitle', 'demonstration.labels.successDesc'),
              buildAlert('default', 'mbds-alert-warning', 'warning', 'demonstration.labels.warningTitle', 'demonstration.labels.warningDesc'),
            );
            return wrap;
          },
        });
          ...
          items: [
            {
              ...
              code: codeDefault,
              previewFactory: () => buildAlert('default', 'mbds-w-full', 'info', 'demonstration.labels.infoTitle', 'demonstration.labels.infoDesc'),
            },
            {
              name: 'destructive',
              description: stripHtml(t('variants.items.destructive')),
              code: codeDestructive,
              previewFactory: () => buildAlert('destructive', 'mbds-w-full', 'error', 'demonstration.labels.errorTitle', 'demonstration.labels.errorDesc'),
            },
            {
              name: 'success',
              description: stripHtml(t('variants.items.success')),
              code: codeSuccess,
              previewFactory: () => buildAlert('default', 'mbds-w-full mbds-alert-success', 'success', 'demonstration.labels.successTitle', 'demonstration.labels.successDesc'),
            },
            {
              name: 'warning',
              description: stripHtml(t('variants.items.warning')),
              code: codeWarning,
              previewFactory: () => buildAlert('default', 'mbds-w-full mbds-alert-warning', 'warning', 'demonstration.labels.warningTitle', 'demonstration.labels.warningDesc'),
            },
            {
              name: t('states.withoutTitle.label'),
              description: t('states.withoutTitle.behavior'),
              code: codeWithoutTitle,
              previewFactory: () => buildAlert('default', 'mbds-w-full', 'info', null, 'demonstration.labels.infoDesc'),
            },
          ],
        });
      }
          ...
          items: [
            ...
            },
            {
              ...
              code:
                ...
                `desc.className = 'mbds-cluster mbds-alert-description mbds-mt-1';\n` +
              ...
              previewFactory: () => {
                const el = createAlert({ className: 'mbds-w-full' });
                el.appendChild(createAlertIcon('info'));
                el.appendChild(createAlertTitle({ text: 'Sessão expira em 5 minutos' }));
                const desc = document.createElement('div');
                desc.className = 'mbds-alert-description mbds-cluster';
            ...
            },
            {
              ...
              previewFactory: () => buildAlert('destructive', 'mbds-w-full', 'error', null, 'demonstration.labels.errorDesc'),
            },
            {
              ...
              code:
                ...
                `\n` +
                `const ok = createAlert({ className: 'mbds-alert-success' });\n` +
                ...
                `\n` +
                `const warn = createAlert({ className: 'mbds-alert-warning' });\n` +
              ...
              previewFactory: () => {
                const wrapper = document.createElement('div');
                wrapper.className = 'mbds-stack mbds-w-full';
                const info = createAlert();
                info.appendChild(createAlertIcon('info'));
                info.appendChild(createAlertTitle({ text: 'Informação' }));
                info.appendChild(createAlertDescription({ text: 'Mensagem informativa e neutra.' }));
  ...
  --warning: 48 96% 53%;
        ...
        return createDocsTokens({
          ...
          items: [
            ...
            { token: '--success',     value: '.mbds-alert-success',             description: t('tokens.table.success') },
            { token: '--warning',     value: '.mbds-alert-warning',             description: t('tokens.table.warning') },
