...
function buildHorizontalDemo(label: string): HTMLElement {
  ...
  wrap.className = 'mbds-w-full mbds-max-w-sm mbds-stack';
  wrap.dataset.spacing = 'sm';

  const caption = document.createElement('div');
  caption.className = 'mbds-text-caption mbds-text-muted-foreground';
  caption.textContent = label;

  const top = document.createElement('p');
  top.className = 'mbds-text-body mbds-font-medium';
...
function buildMenuDemo(label: string): HTMLElement {
  const wrap = document.createElement('div');
  wrap.className = 'mbds-w-full mbds-max-w-xs mbds-stack';
  wrap.dataset.spacing = 'sm';
  ...
  menu.className = 'mbds-stack mbds-rounded-md mbds-border-default mbds-bg-background mbds-p-1 mbds-text-body';
  ...
  items1.forEach((txt) => {
    ...
    item.className = 'mbds-rounded-sm mbds-hover-bg-accent mbds-px-2';
...
function buildCardDemo(label: string): HTMLElement {
  ...
  card.className = 'mbds-rounded-md mbds-border-default mbds-bg-background';

  const header = document.createElement('div');
  header.className = 'mbds-p-4';
  const headerTitle = document.createElement('p');
  headerTitle.className = 'mbds-text-body mbds-font-semibold';
  headerTitle.textContent = 'Cabeçalho do Card';
  const headerDesc = document.createElement('p');
  headerDesc.className = 'mbds-text-caption mbds-text-muted-foreground';
  headerDesc.textContent = 'Descrição curta da seção.';
  header.append(headerTitle, headerDesc);

  const body = document.createElement('div');
  body.className = 'mbds-p-4 mbds-text-body mbds-text-muted-foreground';
          ...
          pairs: [
            {
              ...
              doPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-w-full mbds-max-w-xs mbds-stack mbds-rounded-md mbds-border-default mbds-bg-background mbds-p-1 mbds-text-body';
                wrap.dataset.spacing = 'xs';
                const a = document.createElement('div');
                a.className = 'mbds-px-2';
                a.style.paddingBlock = '0.375rem';
                a.textContent = 'Perfil';
                const b = document.createElement('div');
                b.className = 'mbds-px-2';
                b.style.paddingBlock = '0.375rem';
                b.textContent = 'Conta';
                const c = document.createElement('div');
                c.className = 'mbds-px-2';
              ...
              dontPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-w-full mbds-max-w-xs mbds-stack mbds-text-body';
                wrap.dataset.spacing = 'xs';
                const a = document.createElement('p');
                a.textContent = 'Linha 1';
                const sep = createSeparator({ orientation: 'horizontal' });
                sep.classList.add('mbds-my-2');
            ...
            },
            {
              ...
              doPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-cluster mbds-w-full mbds-max-w-sm';
                wrap.dataset.spacing = 'sm';
              ...
              dontPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-block mbds-w-full mbds-max-w-sm';
                const a = document.createElement('span');
                a.className = 'mbds-text-body';
                a.textContent = 'Blog';
                const b = document.createElement('span');
