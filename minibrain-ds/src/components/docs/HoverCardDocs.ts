...
function buildProfilePreview(): HTMLElement {
  ...
  trigger.href = '#joana';
  trigger.className = 'mbds-text-primary mbds-hover-underline';
  ...
  name.className = 'mbds-font-medium mbds-text-body';
...
function buildLinkPreview(): HTMLElement {
  ...
  meta.className = 'mbds-cluster mbds-text-caption mbds-text-muted-foreground';
  meta.dataset.spacing = 'sm';
  const favicon = document.createElement('span');
  favicon.className = 'mbds-icon mbds-rounded-sm mbds-bg-muted';
  ...
  title.className = 'mbds-font-medium';
...
function buildDefinitionPreview(): HTMLElement {
  ...
  const content = document.createElement('div');
  const title = document.createElement('p');
  title.className = 'mbds-font-medium mbds-text-body';
...
function buildMetricPreview(): HTMLElement {
  ...
  value.className = 'mbds-text-h4 mbds-font-semibold';
          ...
          pairs: [
            {
              ...
              doPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-text-body mbds-stack';
                wrap.dataset.spacing = 'xs';
                const link = document.createElement('div');
                link.className = 'mbds-text-primary';
              ...
              dontPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-text-body';
                const link = document.createElement('div');
                link.className = 'mbds-text-primary';
                link.style.textDecoration = 'underline';
                link.textContent = '@joana';
                const note = document.createElement('div');
                note.className = 'mbds-text-caption mbds-text-muted-foreground mbds-italic';
...
createHoverCard({ trigger, content, side: 'bottom', align: 'start' });`;
        ...
        const codeWithDelay = `// MiniBrain factory: delays internos fixos (SHOW_DELAY=300ms, HIDE_DELAY=150ms).
        ...
        return createDocsVariants({
          ...
          items: [
            ...
            },
            {
              ...
              previewFactory: () => {
                const note = document.createElement('div');
                note.className = 'mbds-text-caption mbds-font-mono mbds-text-muted-foreground';
...
trigger.href = '/users/joana';
trigger.className = 'mbds-text-primary underline-offset-4 hover:underline';
trigger.textContent = '@joana';
...
meta.className = 'mbds-cluster mbds-text-caption mbds-text-muted-foreground';
const favicon = document.createElement('span');
favicon.className = 'mbds-cluster mbds-rounded mbds-bg-muted';
...
trigger.type = 'button';
trigger.className = 'mbds-text-primary mbds-text-body mbds-font-medium';
...
term.className = 'mbds-font-medium mbds-text-body';
...
const el = createHoverCard({ trigger, content, side: 'bottom', align: 'start' });`,
              previewFactory: () => {
                ...
                trigger.type = 'button';
                trigger.className =
                  'mbds-text-primary mbds-text-body mbds-font-medium mbds-cursor-pointer';
                Object.assign(trigger.style, { background: 'transparent', border: '0', padding: '0', textDecoration: 'underline dotted', textUnderlineOffset: '4px', cursor: 'help' });
                trigger.textContent = 'WCAG 2.1 AA';
          ...
          tables: [
            {
              ...
              items: [
                ...
                { name: 'openDelay',    type: 'number',                                   defaultValue: '300',       required: 'Não', description: stripHtml(t('props.table.openDelay.description')) + ' NOTA: factory MiniBrain usa constante interna SHOW_DELAY (não-prop).' },
              ],
            },
          ],
          interfaceCode,
