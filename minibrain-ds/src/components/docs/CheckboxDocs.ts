...
function buildCheckboxWithLabel(opts: {
  ...
  if (labelText) {
    ...
    label.className = 'mbds-text-body mbds-font-medium mbds-leading-none' + (disabled ? ' mbds-cursor-default' : ' mbds-cursor-pointer');
    ...
    switch (id) {
      ...
      case 'do-dont': {
        const buildLabeledCheckbox = (labelText: string, checked = false) => {
          ...
          label.htmlFor = id;
          label.textContent = labelText;
          label.className = 'mbds-text-body mbds-font-medium mbds-cursor-pointer';
          row.append(cb, label);
          return row;
        };
        ...
        const buildFieldset = (legendText: string, itemLabels: string[]) => {
          ...
          fs.className = 'mbds-border-default mbds-rounded-lg mbds-stack mbds-w-full';
          fs.dataset.spacing = 'xs';
          fs.style.padding = '0.75rem';
          const legend = document.createElement('legend');
          legend.className = 'mbds-text-caption mbds-font-semibold mbds-px-1';
          ...
          pairs: [
            ...
            },
            {
              ...
              dontPreviewFactory: () => {
                ...
                loose.className = 'mbds-stack mbds-w-full';
          ...
          items: [
            ...
            },
            {
              ...
              code:
                ...
                `fieldset.className = 'mbds-border-default mbds-rounded-lg mbds-p-4 mbds-stack';\n` +
                `fieldset.dataset.spacing = 'sm';\n` +
                `fieldset.style.width = '18rem';\n` +
                `const legend = document.createElement('legend');\n` +
                `legend.className = 'mbds-text-body mbds-font-semibold mbds-px-1';\n` +
            ...
            },
            {
              ...
              code:
                ...
                `allRow.className = 'mbds-cluster mbds-border-b';\n` +
                ...
                `labelAll.className = 'mbds-text-body mbds-font-semibold mbds-leading-none mbds-cursor-pointer';\n` +
            ...
            },
            {
              ...
              code:
                ...
                `  const row = document.createElement('div');\n` +
                `  row.className = 'mbds-cluster mbds-rounded-md mbds-border-default';\n` +
                `  row.dataset.justify = 'between';\n` +
                `  row.style.paddingInline = '0.75rem';\n` +
                `  row.style.paddingBlock = '0.5rem';\n` +
                `  const leftSide = document.createElement('div');\n` +
                `  leftSide.className = 'mbds-cluster';\n` +
...
export type CheckboxOptions = {
  ...
  'aria-label'?: string;
        ...
        return createDocsProps({
          ...
          extensibilityNotes: 'O MiniBrain não suporta estado indeterminate. Use createCheckbox() apenas para checked/unchecked/disabled. O estado indeterminate está disponível exclusivamente no Svelte via prop bindable.',
        });
      }
