...
function makeTriggerArea(label: string): HTMLElement {
  ...
  el.className =
    'mbds-cluster mbds-w-full mbds-rounded-md mbds-border-default mbds-text-body mbds-text-muted-foreground mbds-cursor-default';
...
function buildSimpleTriggerArea(label: string): HTMLElement {
  ...
  wrap.className = 'mbds-cluster mbds-p-4';
    ...
    switch (id) {
      ...
      case 'demonstracao':
        return createDocsDemonstration({
          ...
          demoFactory: () => {
            const wrap = document.createElement('div');
            wrap.className = 'mbds-cluster mbds-p-8';
            wrap.dataset.align = 'center';
            wrap.dataset.justify = 'center';
          ...
          pairs: [
            {
              ...
              doPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-stack mbds-text-body mbds-p-2';
                wrap.dataset.spacing = 'sm';
                const label = document.createElement('p');
                label.className = 'mbds-text-muted-foreground mbds-text-caption';
                ...
                ['Editar', 'Duplicar', 'Excluir'].forEach(a => {
                  ...
                  btn.className = 'mbds-text-caption mbds-px-2 mbds-py-1 mbds-rounded mbds-border-default mbds-hover-bg-accent';
                  btn.textContent = a;
              ...
              dontPreviewFactory: () => {
                const wrap = document.createElement('div');
                wrap.className = 'mbds-cluster mbds-p-2 mbds-text-body';
                wrap.dataset.align = 'center';
                wrap.dataset.justify = 'center';
                const area = makeTriggerArea(t('demonstration.labels.triggerLabel'));
                area.style.opacity = '0.6';
                const note = document.createElement('p');
                note.className = 'mbds-text-caption mbds-text-muted-foreground mbds-mt-2';
            ...
            },
            {
              ...
              doPreviewFactory: () => {
                ...
                menu.className =
                  'mbds-overflow-hidden mbds-rounded-md mbds-border-default mbds-shadow-md';
                ...
                function mkItem(label: string, destructive = false) {
                  ...
                  li.className = [
                    'mbds-cluster mbds-rounded-sm mbds-px-2 mbds-text-body',
            ...
            },
            {
              ...
              doPreviewFactory: () => {
                ...
                li.setAttribute('role', 'menuitem');
                li.className =
                  'mbds-cluster mbds-rounded-md mbds-px-2 mbds-text-body mbds-border-default';
                li.style.minWidth = '160px';
                const labelSpan = document.createElement('span');
                labelSpan.className = 'mbds-flex-1';
                labelSpan.textContent = 'Editar';
                const sc = document.createElement('span');
                sc.className = 'mbds-text-caption mbds-tracking-wider mbds-text-muted-foreground';
...
li.className = 'mbds-cluster mbds-rounded-sm mbds-px-2 mbds-text-body';`;
          ...
          items: [
            ...
            },
            {
              ...
              previewFactory: () => {
                ...
                li.setAttribute('role', 'menuitem');
                li.className =
                  'mbds-cluster mbds-rounded-md mbds-px-2 mbds-text-body mbds-text-destructive mbds-border-destructive-soft';
...
subTrigger.className = '... mbds-cluster ...';
...
lbl.className = 'mbds-px-2 mbds-text-caption mbds-font-semibold mbds-text-muted-foreground';
lbl.textContent = 'Ações';`,
              previewFactory: () => {
                const li = document.createElement('li');
                li.setAttribute('role', 'presentation');
                li.className =
                  'mbds-px-2 mbds-text-caption mbds-font-semibold mbds-text-muted-foreground mbds-border-default mbds-rounded-md';
                li.style.minWidth = '160px';
...
const indicator = document.createElement('span');
indicator.className = 'mbds-cluster';
          ...
          items: [
            ...
            },
            {
              ...
              previewFactory: () => {
                ...
                subLabel.className = 'mbds-flex-1';
