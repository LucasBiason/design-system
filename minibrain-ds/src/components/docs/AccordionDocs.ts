...
function buildDemoAccordion(): HTMLElement {
  return createAccordion({
    type: 'single',
    collapsible: true,
    class: 'mbds-w-full mbds-max-w-lg',
    items: [
      {
        value: 'q1',
    ...
    switch (id) {
          ...
          pairs: [
            {
              ...
              doPreviewFactory: () => createAccordion({
                type: 'single', collapsible: true, class: 'mbds-w-full mbds-max-w-xs mbds-text-body',
            ...
            },
            {
              ...
              doPreviewFactory: () => createAccordion({
                type: 'multiple', class: 'mbds-w-full mbds-max-w-xs mbds-text-body',
                items: [
          ...
          items: [
            {
              ...
              previewFactory: () => createAccordion({
                type: 'single', collapsible: true, defaultValue: 'item-1', class: 'mbds-w-full mbds-max-w-sm mbds-text-body',
                items: [
            ...
            },
            {
              ...
              code: codeMultiple,
              previewFactory: () => createAccordion({
                type: 'multiple', class: 'mbds-w-full mbds-max-w-sm mbds-text-body',
                items: [
                  { value: 's1', trigger: 'Especificações técnicas', content: 'CPU, RAM, SSD.' },
                  { value: 's2', trigger: 'Compatibilidade', content: 'Windows 11, macOS, Linux.' },
                ],
      ...
      case 'composicoes': {
        ...
        const makeIcon = (nodes: IconNode[]): SVGSVGElement => {
          ...
          svg.setAttribute('class', 'mbds-icon-sm mbds-shrink-0');
          ...
          items: [
            {
              ...
              previewFactory: () => {
                ...
                root.className = 'mbds-w-full mbds-max-w-lg';
                const iconItems = [
            ...
            },
            {
              ...
              previewFactory: () => {
                ...
                const layoutHtml = `
                  <div class="mbds-stack mbds-text-body" data-spacing="xs">
                    <div class="mbds-grid mbds-font-medium" data-cols="2" data-spacing="xs">
                      <span class="mbds-text-muted-foreground">Propriedade</span>
                      <span class="mbds-text-muted-foreground">Valor</span>
                    </div>
                    <div class="mbds-grid" data-cols="2" data-spacing="xs" style="border-top:1px solid var(--border);padding-top:0.5rem"><span>Gutter</span><code class="mbds-text-caption mbds-bg-muted-soft mbds-rounded" style="padding:0 0.25rem">24px</code></div>
                    <div class="mbds-grid" data-cols="2" data-spacing="xs" style="border-top:1px solid var(--border);padding-top:0.5rem"><span>Margem mobile</span><code class="mbds-text-caption mbds-bg-muted-soft mbds-rounded" style="padding:0 0.25rem">16px</code></div>
                    <div class="mbds-grid" data-cols="2" data-spacing="xs" style="border-top:1px solid var(--border);padding-top:0.5rem"><span>Colunas</span><code class="mbds-text-caption mbds-bg-muted-soft mbds-rounded" style="padding:0 0.25rem">12</code></div>
                  </div>`;
                const tipoHtml = `
                  <ul class="mbds-stack mbds-text-body mbds-list-none" data-spacing="xs" style="padding:0">
                    <li class="mbds-cluster" data-spacing="xs"><code class="mbds-text-caption mbds-bg-muted-soft mbds-rounded" style="padding:0 0.25rem">text-xs</code><span>12px — legendas e labels</span></li>
                    <li class="mbds-cluster" data-spacing="xs"><code class="mbds-text-caption mbds-bg-muted-soft mbds-rounded" style="padding:0 0.25rem">text-sm</code><span>14px — corpo principal</span></li>
                    <li class="mbds-cluster" data-spacing="xs"><code class="mbds-text-caption mbds-bg-muted-soft mbds-rounded" style="padding:0 0.25rem">text-base</code><span>16px — títulos de seção</span></li>
                  </ul>`;
            ...
            },
            {
              ...
              previewFactory: () => {
                ...
                wrapper.dataset.spacing = 'xs';
                const heading = document.createElement('h2');
                heading.className = 'mbds-text-base mbds-font-semibold';
                heading.textContent = 'Perguntas frequentes';
                wrapper.append(heading, createAccordion({
                  type: 'single', collapsible: true,
                  items: [
