          ...
          pairs: [
            ...
            },
            {
              ...
              doPreviewFactory: () => {
                ...
                const emptyCell = createTableCell('Nenhuma fatura encontrada.', 'mbds-text-muted-foreground');
...
container.appendChild(pagination);`;
        ...
        function buildFilterableToolbarPreview(): HTMLElement {
          ...
          container.className = 'mbds-stack mbds-w-full';
          container.dataset.spacing = 'sm';

          const toolbar = document.createElement('div');
          toolbar.className = 'mbds-cluster';
          toolbar.dataset.spacing = 'xs';
          const input = createInput({ placeholder: 'Filtrar faturas...', class: 'mbds-max-w-sm' });
          toolbar.appendChild(input);
          const filterBtn = createButton({ variant: 'outline', label: 'Status' });
          toolbar.appendChild(filterBtn);
          container.appendChild(toolbar);
