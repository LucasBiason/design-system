...
function buildLocalToast(type: string, message: string, opts: LocalToastOpts = {}): HTMLElement {
  ...
  toastEl.className = `mbds-w-full mbds-max-w-sm mbds-rounded-lg mbds-border-default mbds-shadow-lg mbds-cluster ${colorClass}`;
  ...
  if (opts.description) {
    ...
    descEl.className = 'mbds-text-body mbds-text-muted-foreground';
  ...
  if (opts.actionLabel && opts.onAction) {
    ...
    actionBtn.className = 'mbds-text-body mbds-font-medium mbds-text-primary mbds-hover-underline';
  ...
  closeBtn.className = 'mbds-shrink-0 mbds-text-muted-foreground mbds-hover-text-foreground';
